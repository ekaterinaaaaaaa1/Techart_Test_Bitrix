...
{?>
	<div class="container authorized"><?= Loc::getMessage('MAIN_AUTH_FORM_SUCCESS');?></div>
<?return;
}
?>
...
<div class="bx-authform container">
	...
	<form name="<?= $arResult['FORM_ID'];?>" method="post" target="_top" action="<?= POST_FORM_ACTION_URI;?>">
		...
		<div class="bx-authform-formgroup-container">
			<input type="submit" class="btn btn-primary button news-button" name="<?= $arResult['FIELDS']['action'];?>" value="<?= Loc::getMessage('MAIN_AUTH_FORM_FIELD_SUBMIT');?>" />
		</div>
